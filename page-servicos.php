...
<!-- Serviços -->
<div class="bg-white w-full px-4 py-10">
    <div class="max-w-6xl mx-auto">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div class="bg-primary rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="p-8">
                    <div class="flex items-center justify-center w-16 h-16 bg-white rounded-full mb-4">
                        <i class="fas fa-balance-scale text-3xl text-primary"></i>
                    </div>
                    <h3 class="text-white text-2xl font-bold mb-4">Direito Civil</h3>
            ...
            <!-- Direito Ambiental -->
            <div class="bg-white border-2 border-primary rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="p-8">
            ...
            <!-- Direito de Família -->
            <div class="bg-primary md:bg-white border-2 border-primary rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="p-8">
                    <div class="flex items-center justify-center w-16 h-16 bg-white md:bg-primary rounded-full mb-4">
                        <i class="fas fa-home text-3xl text-primary md:text-white"></i>
                    </div>
                    <h3 class="text-white md:text-primary text-2xl font-bold mb-4">Direito de Família</h3>
                    <p class="text-white md:text-secondary text-sm mb-3">
                    ...
                    <p class="text-white md:text-secondary text-sm">
            ...
            <div class="bg-white md:bg-primary rounded-lg border-2 border-primary shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="p-8">
                    <div class="flex items-center justify-center w-16 h-16 bg-primary md:bg-white rounded-full mb-4">
                        <i class="fas fa-globe-americas text-3xl text-white md:text-primary"></i>
                    </div>
                    <h3 class="text-primary md:text-white text-2xl font-bold mb-4">Comércio Internacional</h3>
                    <p class="text-primary md:text-white text-sm mb-3">
                    ...
                    <p class="text-primary md:text-white text-sm">
            ...
            <div class="bg-primary rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                <div class="p-8">
                    ...
                    <h3 class="text-white text-2xl font-bold mb-4">Direito do Consumidor</h3>
                    <p class="text-white text-sm mb-3">
             ...
             <div class="md:col-span-2 w-full flex justify-center">
                <div class="md:max-w-1/2 bg-primary border-2 border-primary rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300">
                    <div class="p-8">
                        ...
                        <h3 class="text-white text-2xl font-bold mb-4">Direito Previdenciário</h3>
                        <p class="text-white text-sm mb-3">
...
<div class="bg-primary w-full px-4 py-10">
    <div class="flex flex-col items-center max-w-3xl mx-auto">
        <div class="flex flex-col items-center">
            <h3 class="text-white text-center text-2xl font-bold mb-4">Precisa de assessoria jurídica?</h3>
            <p class="text-white text-center text-sm mb-6 py-5 max-w-80">
        ...
        <div class="flex flex-col items-center">
            <div>
                ...
                <button class="flex items-center justify-center bg-white text-primary font-bold py-3 px-8 rounded-lg hover:bg-secondary hover:text-white transition-colors duration-300">
